 ...
 * to PeerStatusProviderIsUpRequester {@link PeerStatusProviderIsUpRequester}.
 */
public class PeerStatusProviderIsUpRequestTO implements IRequestTO { 
	
	private String REQUEST_TYPE = AggregatorRequestConstants.
								PEER_STATUS_PROVIDER_IS_UP.getString();
