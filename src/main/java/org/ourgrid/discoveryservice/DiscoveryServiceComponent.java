 ...
 *
 */
public class DiscoveryServiceComponent extends ServerModule {

	public DiscoveryServiceComponent(ModuleContext context) throws CommuneNetworkException, ProcessorStartException {
		super(DiscoveryServiceConstants.MODULE_NAME, context);
	}

	@Override
	protected ServerModuleManager createApplicationManager() {
		return new DiscoveryServiceControlReceiver();
	}
