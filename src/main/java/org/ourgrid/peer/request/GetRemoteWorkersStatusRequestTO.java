...
public class GetRemoteWorkersStatusRequestTO implements IRequestTO {

	private static final String REQUEST_TYPE = PeerRequestConstants.GET_REMOTE_WORKERS_STATUS;
