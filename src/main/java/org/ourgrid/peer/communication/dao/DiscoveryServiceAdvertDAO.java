 ...
 * Stores requests
 */
public class DiscoveryServiceAdvertDAO{

	private static DiscoveryServiceAdvertDAO requestDAO;
	
	private Future<?> advertActionFuture;
	
	public static DiscoveryServiceAdvertDAO getInstance() {
		if (requestDAO == null)
			requestDAO = new DiscoveryServiceAdvertDAO();
		return requestDAO;
	}
	 ...
	 */
	@Req("REQ010")
	private DiscoveryServiceAdvertDAO(){}
