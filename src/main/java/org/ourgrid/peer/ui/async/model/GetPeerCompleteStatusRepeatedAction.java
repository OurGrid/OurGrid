 ...
 */
public class GetPeerCompleteStatusRepeatedAction implements RepeatedAction {

	public void run(Serializable handler, ServiceManager serviceManager) {
		PeerAsyncApplicationClient client = (PeerAsyncApplicationClient) serviceManager.getApplication();
