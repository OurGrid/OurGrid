 ...
 *
 */
public class PeerStartCommand extends StartCommand {

	private final PeerSyncApplicationClient application;

	public PeerStartCommand(PeerSyncApplicationClient componentClient) {
		super(componentClient);
		application = componentClient;
	}
