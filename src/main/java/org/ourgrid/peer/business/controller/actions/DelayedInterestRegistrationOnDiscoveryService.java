...
public class DelayedInterestRegistrationOnDiscoveryService implements RepeatedAction {

	public void run(Serializable handler, ServiceManager serviceManager) {
		serviceManager.registerInterest(PeerConstants.DS_CLIENT,
				(String) handler, DiscoveryService.class);
	}
