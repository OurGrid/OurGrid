 ...
 *
 */
public class ResumeWorkerCommand extends AbstractCommand<WorkerSyncComponentClient> {

	public ResumeWorkerCommand(WorkerSyncComponentClient componentClient) {
	...
	protected void execute(String[] params) throws Exception {
		if (isComponentStarted()) {
			getComponentClient().resumeWorker();
		} else {
