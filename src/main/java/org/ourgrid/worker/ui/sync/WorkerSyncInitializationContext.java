...
public class WorkerSyncInitializationContext implements 
	InitializationContext<WorkerManager, WorkerSyncManagerClient> {

	public String getControlModuleName() {
		return WorkerConstants.MODULE_NAME;
	}

	public WorkerSyncManagerClient createManagerClient() {
		return new WorkerSyncManagerClient();
	}
