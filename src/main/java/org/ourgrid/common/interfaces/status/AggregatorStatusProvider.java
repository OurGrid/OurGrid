 ...
 */
@Remote
public interface AggregatorStatusProvider extends ModuleStatusProvider {

	/**
	 * Gets the actual complete status. 
	 * @param client The client of AggregatorStatusProviderClient.
	 */
	void getCompleteStatus( AggregatorStatusProviderClient client );
