...
public class HereIsCompleteJobsStatusResponseTO extends AbstractStatusResponseTO {
	
	
	private final String RESPONSE_TYPE = BrokerResponseConstants.HERE_IS_COMPLETE_JOBS_STATUS;
