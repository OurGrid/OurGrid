...
public class BrokerCancelJobCommand extends AbstractCommand<BrokerSyncApplicationClient> {

	public BrokerCancelJobCommand( BrokerSyncApplicationClient componentClient ) {
	...
	public void run( String[ ] params ) throws Exception {
		...
		getComponentClient().cancelJob( jodID );
		BrokerUIMessages.getJobCanceledMessage( jodID );
	}
