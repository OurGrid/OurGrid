...
public class GetCompleteJobsStatusRequestTO extends AbstractStatusRequestTO {

	
	private final String REQUEST_TYPE = BrokerRequestConstants.GET_COMPLETE_JOBS_STATUS;
