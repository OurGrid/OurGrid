...
public class BrokerControlWSInitializationContext implements 
	InitializationContext<BrokerManager, BrokerControlWSManagerClient> {

	public BrokerControlWSManagerClient createManagerClient() {
		return new BrokerControlWSManagerClient();
	}
