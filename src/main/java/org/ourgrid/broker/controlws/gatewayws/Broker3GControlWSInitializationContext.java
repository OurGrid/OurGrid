...
public class Broker3GControlWSInitializationContext implements 
	InitializationContext<BrokerManager, Broker3GControlWSManagerClient> {

	public Broker3GControlWSManagerClient createManagerClient() {
		return new Broker3GControlWSManagerClient();
	}
