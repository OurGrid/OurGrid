...
public class HereIsPagedTasksSender implements SenderIF<HereIsPagedTasksResponseTO> {

	public void execute(HereIsPagedTasksResponseTO response, ServiceManager manager) {
		...
		client.hereIsPagedTasks(myID, response.getJobId(), response.getOffset(), response.getPagedTasks());
	}
}
