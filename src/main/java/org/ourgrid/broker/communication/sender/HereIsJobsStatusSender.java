...
public class HereIsJobsStatusSender implements SenderIF<HereIsJobsStatusResponseTO> {

	public void execute(HereIsJobsStatusResponseTO response, ServiceManager manager) {
		...
		client.hereIsJobsStatus(myID, response.getJobPackage());
	}
}
