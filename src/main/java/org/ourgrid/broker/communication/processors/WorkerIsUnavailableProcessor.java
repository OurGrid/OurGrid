...
import org.ourgrid.broker.request.WorkerIsUnavailableProcessorRequestTO;
 ...
 * 
 */
public class WorkerIsUnavailableProcessor implements MessageProcessor<WorkerIsUnavailableMessageHandle> {
	 ...
	 */
	public void process(WorkerIsUnavailableMessageHandle handle, ServiceManager serviceManager) {
		WorkerIsUnavailableProcessorRequestTO to = new WorkerIsUnavailableProcessorRequestTO();
