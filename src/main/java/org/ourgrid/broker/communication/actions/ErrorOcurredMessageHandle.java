...
public class ErrorOcurredMessageHandle extends MessageHandle {
	...
	private GridProcessError error;

	public ErrorOcurredMessageHandle(GridProcessError error) {
		super(BrokerConstants.ERROR_OCURRED_ACTION_NAME);
		this.error = error;
	}
