...
public class HereIsGridProcessResultMessageHandle extends MessageHandle {
	...
	public HereIsGridProcessResultMessageHandle(ExecutorResult result) {
		super(BrokerConstants.HERE_IS_EXECUTION_RESULT_ACTION_NAME);
		this.result = result;
	}
