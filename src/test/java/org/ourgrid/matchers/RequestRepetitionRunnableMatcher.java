...
/**
 */
public class RequestRepetitionRunnableMatcher implements IArgumentMatcher {
	 ...
	 * @param runnable
	 */
	public RequestRepetitionRunnableMatcher(RepetitionRunnable runnable) {
	...
	public boolean matches(Object arg0) {
		...
		if(runnable.getHandler() != otherRunnable.getHandler()) {
			return false;
		}
	...
	public static RepetitionRunnable eqMatcher(RepetitionRunnable runnable) {
		EasyMock.reportMatcher(new RequestRepetitionRunnableMatcher(runnable));
		return null;
	}
