 ...
 *
 */
public class DiscoveryServiceRepetitionRunnableMatcher implements IArgumentMatcher {
	 ...
	 * @param runnable
	 */
	public DiscoveryServiceRepetitionRunnableMatcher(RepetitionRunnable runnable) {
	...
	public static RepetitionRunnable eqMatcher(RepetitionRunnable runnable) {
		EasyMock.reportMatcher(new DiscoveryServiceRepetitionRunnableMatcher(runnable));
		return null;
	}
