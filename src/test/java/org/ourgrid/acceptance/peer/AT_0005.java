...
public class AT_0005 extends PeerAcceptanceTestCase {
	...
	/**
	 * Verifies if the advertise is done after setWorkers command.
	 */
	@ReqTest(test="AT-0005", reqs="")
	@Test public void test_AT_0005_AdvertAfterDiscoveryServiceRecovery() throws Exception {
		//Start peer 
		component = req_010_Util.startPeer();
		
		//Notify ds peer recovery
        ...
        //Change workers status to IDLE and expect the peer advertise then in ds
		req_025_Util.changeWorkerStatusToIdleWithAdvert(component, workerSpecA, workerAID, dsID);
        req_025_Util.changeWorkerStatusToIdleWithAdvert(component, workerSpecB, workerBID, dsID);
        req_025_Util.changeWorkerStatusToIdleWithAdvert(component, workerSpecC, workerCID, dsID);
	}
	
	@Category(JDLCompliantTest.class)
	@Test public void test_AT_0005_AdvertAfterDiscoveryServiceRecoveryWithJDL() throws Exception {
		//Start peer 
		component = req_010_Util.startPeer();
