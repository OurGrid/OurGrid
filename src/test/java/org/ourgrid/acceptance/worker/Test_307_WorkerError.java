...
public class Test_307_WorkerError extends WorkerAcceptanceTestCase {
	...
	@Test public void test_307_1_Start() throws Exception {
		req_004_Util.startWorkerAlreadyStarted(component);
	}

	@Test public void test_307_2_Pause() throws Exception {
		req_094_Util.getWorkerStatus(WorkerStatus.ERROR);
		req_087_Util.pauseErrorWorker(prepFuture, component);
		req_094_Util.getWorkerStatus(WorkerStatus.ERROR);
	}
	
	@Test public void test_307_3_Resume() throws Exception {
		req_094_Util.getWorkerStatus(WorkerStatus.ERROR);
		req_088_Util.resumeNotOwnerWorker(component);
		req_094_Util.getWorkerStatus(WorkerStatus.ERROR);
	}

	@Test public void test_307_4_Status() throws Exception {
		req_094_Util.getWorkerStatus(WorkerStatus.ERROR);
	}

	@Test public void test_307_7_WorkerManagementClientIsDown() throws Exception {
		req_094_Util.getWorkerStatus(WorkerStatus.ERROR);
		req_127_Util.notifyPeerFailureAtErrorWorker(component, peerID);
		req_094_Util.getWorkerStatus(WorkerStatus.ERROR);
	}

	@Test public void test_307_8_WorkerManagementClientIsUp() throws Exception {
	...
	@Test public void test_307_9_ConcurrentExecutionError() throws Exception {
		//Not necessary
	}
	
	@Test public void test_307_10_ExecutionError() throws Exception {
		req_128_Util.executionErrorOnErrorWorker(component);
	}
	
	@Test public void test_307_11_ExecutionResult() throws Exception {
		req_128_Util.executionResultOnErrorWorker(component);
	}
	
	@Test public void test_307_12_ExecutionIsRunning() throws Exception {
		req_128_Util.executionIsRunningOnErrorWorker(component);
	}
	
	@Test public void test_307_13_AllocationError() throws Exception {
		req_125_Util.allocationErrorOnNotPreparingWorker(component, WorkerStatus.ERROR);
	}
	
	@Test public void test_307_14_ReadyForAllocation() throws Exception {
		req_092_Util.prepareAllocationCompletedOnErrorWorker(component);
	}

	@Test public void test_307_15_Stop() throws Exception {
