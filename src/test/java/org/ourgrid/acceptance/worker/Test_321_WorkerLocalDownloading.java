...
public class Test_321_WorkerLocalDownloading extends WorkerAcceptanceTestCase {
	...
	public void setUp() throws Exception {
		...
		handle = req_080_Util.requestToTransferFile(component,
				1, brokerID.getContainerID(), filePath, fileName, operationType, 0, 256);
	}
	...
	@Test public void test_321_1_Start() throws Exception {
	...
	@Test public void test_321_2_WorkerManagementClientIsUp() throws Exception {
	...
	@Test public void test_321_3_LoginSucceeded() throws Exception {
		FileTransferDAO fileTransferDAO = WorkerDAOFactory.getInstance().getFileTransferDAO();
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
		TestCase.assertFalse(fileTransferDAO.getIncomingFileHandles().isEmpty());
	...
	@Test public void test_321_4_WorkForPeer() throws Exception {
		FileTransferDAO fileTransferDAO = WorkerDAOFactory.getInstance().getFileTransferDAO();
		...
		req_006_Util.workForPeerOnAllocatedForBrokerWorkerOnWorkingStateWithIncomingFile(
	...
	@Test public void test_321_5_PreparationError() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
		TestCase.assertTrue(workerStatus.isAllocatedForBroker());
		TestCase.assertTrue(workerStatus.isWorkingState());
	...
	@Test public void test_321_6_StartWork() throws Exception {
		FileTransferDAO fileTransferDAO = WorkerDAOFactory.getInstance().getFileTransferDAO();
		TestCase.assertFalse(fileTransferDAO.getIncomingFileHandles().isEmpty());
	...
	@Test public void test_321_7_GetFiles() throws Exception {
		FileTransferDAO fileTransferDAO = WorkerDAOFactory.getInstance().getFileTransferDAO();
		TestCase.assertFalse(fileTransferDAO.getIncomingFileHandles().isEmpty());
	...
	@Test public void test_321_8_RemoteExecute() throws Exception {
		Worker worker = workerAcceptanceUtil.getWorker();
		...
		req_084_Util.remoteExecutionWithWokerWithIncomingFile(component, worker,
	...
	@Test public void test_321_9_TransferRejected() throws Exception {
		FileTransferDAO fileTransferDAO = WorkerDAOFactory.getInstance().getFileTransferDAO();
		TestCase.assertFalse(fileTransferDAO.getIncomingFileHandles().isEmpty());
		...
		req_081_Util.receiveFileRejectDownloadingStateWorker(
				component, workerClient, brokerID.getPublicKey(), 
	...
	@Test public void test_321_10_ReadyForAllocation() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
		TestCase.assertTrue(workerStatus.isAllocatedForBroker());
		TestCase.assertTrue(workerStatus.isWorkingState());
	...
	@Test public void test_321_11_OutgoingTransferCancelled() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		WorkerClient workerClient = EasyMock.createMock(WorkerClient.class);
	...
	@Test public void test_321_12_OutgoingTransferFailed() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		WorkerClient workerClient = EasyMock.createMock(WorkerClient.class);
	...
	@Test public void test_321_13_OutgoingTransferCompleted() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		WorkerClient workerClient = EasyMock.createMock(WorkerClient.class);
	...
	@Test public void test_321_14_WorkerClientIsUp() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
	...
	@Test public void test_321_15_ConcurrentExecutionError() throws Exception {
		//Not Necessary
	}

	@Test public void test_321_16_ExecutionError() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
	...
	@Test public void test_321_17_ExecutionResult() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
		TestCase.assertTrue(workerStatus.isAllocatedForBroker());
		TestCase.assertTrue(workerStatus.isWorkingState());
	...
	@Test public void test_321_18_ExecutionIsRunning() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
		TestCase.assertTrue(workerStatus.isAllocatedForBroker());
		TestCase.assertTrue(workerStatus.isWorkingState());
	...
	@Test public void test_321_19_Resume() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
	...
	@Test public void test_321_20_Status() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		TestCase.assertTrue(workerStatus.isLogged());
	...
	@Test public void test_321_21_GetFileInfo() throws Exception {
	...
	@Test public void test_321_22_UpdateTransferProgress() throws Exception {
		//Not necessary
	}

	@Test public void test_321_23_WorkerManagementClientIsDown() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		req_094_Util.getWorkerStatus(WorkerStatus.ALLOCATED_FOR_BROKER);
		TestCase.assertNotNull(workerStatus.getMasterPeerAddress());
		TestCase.assertTrue(workerStatus.isLogged());
	...
	@Test public void test_321_24_IncomingTransferCompleted() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
	...
	@Test public void test_321_25_IncomingTransferFailed() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		...
		req_080_Util.receiveIncomingTransferFailedDownloadingStateWorker(component,
				worker, workerClient, incomingHandle, new Exception(), 12, brokerID);
	...
	@Test public void test_321_26_StopWorking() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		req_094_Util.getWorkerStatus(WorkerStatus.ALLOCATED_FOR_BROKER);
		TestCase.assertNotNull(workerStatus.getMasterPeerAddress());
		TestCase.assertEquals(workerStatus.getMasterPeerAddress(), peerID.getServiceID().toString());
	...
	@Test public void test_321_27_WorkerClientIsDown() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
	...
	@Test public void test_321_28_Pause() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		WorkerManagementClient wmc = workerAcceptanceUtil.createWorkerManagementClient(peerID);
		req_094_Util.getWorkerStatus(WorkerStatus.ALLOCATED_FOR_BROKER);
		TestCase.assertNotNull(workerStatus.getMasterPeerAddress());
	...
	@Test public void test_321_29_WorkForBroker() throws Exception {
		WorkerStatusDAO workerStatus = WorkerDAOFactory.getInstance().getWorkerStatusDAO();
		req_094_Util.getWorkerStatus(WorkerStatus.ALLOCATED_FOR_BROKER);
		TestCase.assertNotNull(workerStatus.getMasterPeerAddress());
		TestCase.assertEquals(workerStatus.getMasterPeerAddress(), peerID.getServiceID().toString());
	...
	@Test public void test_321_30_Stop() throws Exception {
